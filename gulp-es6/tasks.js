...
gulp.task("dev-js", ()=>moduleTask("js", "dev_js"));
// function devJs() {
//     return moduleTask("js", "dev_js");
// }

gulp.task("dev-less", ()=>moduleTask("less", "dev_less"));
// function devLess() {
...
function dev_common(files = [config.src.common+"/**/*.js", config.src.common+"/*.js"], dest) {
